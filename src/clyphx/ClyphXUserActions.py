...
accessing Live's API through Python.
...
RESTRICTIONS:
- Action names (which you define in the dictionary below) should NOT be the
  same as any current ClyphX action and should be composed of just letters and
  numbers.
